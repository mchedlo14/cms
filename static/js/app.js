...
(function () {
    ...
    //         } else if (lang == "ar") {
	// 			document.getElementById("header-lang-img").src = "/static/images/flags/ar.svg";
    //         }
    ...
    function windowResizeHover() {
        ...
        if (windowSize < 1025 && windowSize > 767) {
            ...
            if (document.querySelector(".hamburger-icon" != null)) {
                document.querySelector(".hamburger-icon").classList.remove("open");
            }
	...
	// 					break;
    //                     default:
	// 						if (sessionStorage.getItem("data-sidebar") && sessionStorage.getItem("data-sidebar") == "dark") {
	// 							sessionStorage.setItem("data-sidebar", "dark");
	// 							getElementUsingTagname("data-sidebar", "dark");
	// 							document.documentElement.setAttribute("data-sidebar", "dark");
