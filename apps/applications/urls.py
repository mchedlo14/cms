...
urlpatterns = [
    ...
    path("job/companies-lists", view=apps_job_companies_list_view, name="job.companies_lists"),
    ...
    path("job/statistics", view=apps_job_statistics_view, name="job.statistics"),
